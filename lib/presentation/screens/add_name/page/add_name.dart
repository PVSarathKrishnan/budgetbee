...
import 'package:budgetbee/presentation/screens/carousel_page/page/carousel_page.dart';
...
class _AddNameState extends State<AddName> {
            ...
            SizedBox(
              ...
              child: TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  filled: true,
                  fillColor: Color.fromARGB(255, 255, 255, 255).withOpacity(.6),
                  errorBorder: OutlineInputBorder(
                    borderRadius: BorderRadius.circular(30),
                    borderSide: BorderSide(
                        color: Color.fromARGB(255, 254, 113, 103), width: 1.5),
                  ),
                  ...
                  errorStyle: TextStyle(
                      color: Color.fromARGB(255, 255, 60, 46), height: .01),
                  errorMaxLines: 1,
                ),
              ),
            ),
  ...
  String? validateFullName(String? value) {
    ...
    if (trimmedValue.length > 25) {
      return 'Full Name must be at atmost 25 characters';
    }
