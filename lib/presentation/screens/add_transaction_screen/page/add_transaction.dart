...
import 'package:budgetbee/presentation/screens/add_transaction_screen/widget/amount_textfield.dart';
              ...
              Row(
                ...
                children: [
                  ChoiceChip(
                    ...
                    onSelected: (value) {
                      if (!value) return; // Do nothing if already selected
                      ...
                      setState(() {
                        ...
                        _categoryTextController
                            .clear(); // Clear the text in the category field
                      });
                    },
                  ),
                  SizedBox(
