...
import 'package:budgetbee/presentation/screens/bottom_nav_bar/widget/list_view.dart';
        ...
        child: Column(
          children: [
            ...
            if (transactions.isNotEmpty)
              ListViewBuilder(transactions: transactions, sortAscending: sortAscending),
