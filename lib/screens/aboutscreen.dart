            ...
            children: [
              ...
              Align(
                ...
                child: Container(
                  ...
                  child: Padding(
                    padding: const EdgeInsets.only(top: 15, bottom: 11, left: 11, right: 11),
                    child: Text(
              ...
              SizedBox(height: 180,), // Providing space
              Container(
                width: 130,
                height: 30,
                decoration: BoxDecoration(
                  color: const Color.fromARGB(255, 0, 0, 0).withOpacity(.8), // Setting container color
